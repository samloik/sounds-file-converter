...
# 19 поддерживаемых форматов (без RAW и AMR)
SUPPORTED_FORMATS: Dict[str, Dict[str, Any]] = {
    ...
    'ac3': {'format': 'ac3', 'codec': 'ac3', 'bitrate': '192k', 'reliable': True},
    'au': {'format': 'au', 'codec': 'pcm_mulaw', 'reliable': True},
    'pcm': {'format': 'wav', 'codec': 'pcm_s16le', 'reliable': True},
    'mp2': {'format': 'mp2', 'codec': 'mp2', 'bitrate': '192k', 'reliable': True},
    'mp4': {'format': 'mp4', 'codec': 'aac', 'bitrate': '192k', 'reliable': True},
    'webm': {'format': 'webm', 'codec': 'libvorbis', 'bitrate': '192k', 'reliable': True},
    'mkv': {'format': 'matroska', 'codec': 'libvorbis', 'bitrate': '192k', 'reliable': True},
    'mov': {'format': 'mov', 'codec': 'aac', 'bitrate': '192k', 'reliable': True},
    '3gp': {'format': '3gp', 'codec': 'aac', 'bitrate': '192k', 'reliable': True},
    'aif': {'format': 'aiff', 'codec': 'pcm_s16be', 'reliable': True},
}
...
async def main_page(request: Request):
    ...
    return templates.TemplateResponse("index8.html", {
        "request": request,
...
async def convert_audio(
    ...
    # Создаем имя выходного файла с исходным именем
    original_name = file.filename
    name_without_ext = os.path.splitext(original_name)[0]
    output_filename = f"converted_{name_without_ext}.{target_format}"
    ...
    logger.info(f"Выходное имя файла: {output_filename}")
    ...
    # Возвращаем сконвертированный файл с правильным именем
    return FileResponse(
        output_path,
